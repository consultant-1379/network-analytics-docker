/*
 * Copyright (c) 2008-2017 Spotfire AB,
...
insert into SN_VERSION (SPOTFIRE_VERSION, SCHEMA_VERSION) values ('44.6', '254');

-- Special groups
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('19e7e430-9997-11da-fbc4-0010ac110215', 'Everyone', 'SPOTFIRE', 'Everyone', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('fed6b2b0-a9e1-11da-8ed2-0010ac110222', 'Administrator', 'SPOTFIRE', 'Administrator', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('a92097e0-07a7-11db-fd44-0010c0a8019b', 'Library Administrator', 'SPOTFIRE', 'Library Administrator', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('96b90a10-1d4d-11de-283a-00100a64216b', 'Scheduled Updates Users', 'SPOTFIRE', 'Scheduled Updates Users', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('5071c63a-b6ca-4f37-aeee-b141be843dda', 'Deployment Administrator', 'SPOTFIRE', 'Deployment Administrator', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('5bd69e2b-6685-4dd6-9858-8990c46c522b', 'Diagnostics Administrator', 'SPOTFIRE', 'Diagnostics Administrator', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('4dd3fc65-c727-474b-976c-96b807f36bd6', 'Web Player Administrator', 'SPOTFIRE', 'Web Player Administrator', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('5f1879fa-2cca-4d03-b47b-ef03e55d927e', 'Scheduling and Routing Administrator', 'SPOTFIRE', 'Scheduling and Routing Administrator', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('6c677f0f-3cbe-4615-85be-8366c7ce3181', 'Script Author', 'SPOTFIRE', 'Script Author', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('2cbe823f-1507-4b56-a822-621f431ee061', 'Custom Query Author', 'SPOTFIRE', 'Custom Query Author', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('8343aa6f-81a0-44ea-bbd4-ed0ed47770ab', 'API User', 'SPOTFIRE', 'API User', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('5732723c-603b-49ec-8630-c964a8135ba5', 'Impersonator', 'SPOTFIRE', 'Impersonator', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('3bf79f12-1842-41d5-9002-fa1d70ce071c', 'Anonymous User', 'SPOTFIRE', 'Anonymous User', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('5a544e10-f305-408b-ae0c-a602eec4ed4f', 'System Account', 'SPOTFIRE', 'System Account', 0);
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('6dc28196-994b-45a9-a289-ac1b9dca9208', 'Automation Services Users', 'SPOTFIRE', 'Automation Services Users', 0);
insert into GROUP_MEMBERS (GROUP_ID) values ('19e7e430-9997-11da-fbc4-0010ac110215');
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED)
  values ('b35d5a9c-ce41-406d-89b7-2b9c77ee3179', 'OAuth2 Client', 'SPOTFIRE', 'OAuth2 Client', 0);
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED) 
  values ('6679bcea-758d-4b72-8d50-32dfa6621239', 'guest', 'ANONYMOUS', 'Guest', 0);
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED) values 
  ('be1277ba-3c2d-4bbb-b4c5-8096c4961e51','nodemanager','SPOTFIRESYSTEM', 'Node Manager System Account', 1);
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED) values 
  ('3ab9a272-8803-4a2c-85f1-95d9916c9f4c','scheduledupdates','SPOTFIRESYSTEM', 'Scheduled Updates System Account', 1);
insert into GROUP_MEMBERS (GROUP_ID, MEMBER_USER_ID) values 
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED) values 
  ('2e738d87-8a69-4e08-b899-ed30acb2ad9c','sbdfcache','SPOTFIRESYSTEM', 'SBDF Cache System Account', 1);
insert into GROUP_MEMBERS (GROUP_ID, MEMBER_USER_ID) values 
  ('5a544e10-f305-408b-ae0c-a602eec4ed4f', '2e738d87-8a69-4e08-b899-ed30acb2ad9c');
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED) values 
  ('341b1e0c-6943-4292-b96a-60de220c0186','monitoring','SPOTFIRESYSTEM', 'Monitoring System Account', 1);
insert into GROUP_MEMBERS (GROUP_ID, MEMBER_USER_ID) values 
  ('5a544e10-f305-408b-ae0c-a602eec4ed4f', '341b1e0c-6943-4292-b96a-60de220c0186');
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED) values 
  ('ba65162e-4958-4fa8-a744-87e003770944','automationservices','SPOTFIRESYSTEM', 'Automation Services System Account', 1);
insert into GROUP_MEMBERS (GROUP_ID, MEMBER_USER_ID) values 
...
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('4f83cd43-71b5-11dd-050e-00100a64217d', 'analysis', 'spotfire', 'analysis', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('4f83cd44-71b5-11dd-050e-00100a64217d', 'poster', 'spotfire', 'poster', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('4f83cd45-71b5-11dd-050e-00100a64217d', 'guide', 'spotfire', 'guide', 0, null, null);

insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('4f83cd46-71b5-11dd-050e-00100a64217d', 'custom', 'spotfire', 'custom', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('4f83cd47-71b5-11dd-050e-00100a64217d', 'dxp', 'spotfire', 'dxp', 1, 'dxp', 'application/vnd.spotfire.dxp');

insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('aec78e32-b5f7-48d6-99ae-97f931202497', 'column', 'spotfire', 'column', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('365d0d4b-63c3-4bb3-ac88-7e71c98e343e', 'filter', 'spotfire', 'filter', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('947059cf-b48b-4245-8547-316621e15cc3', 'join', 'spotfire', 'join', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('b2cdbe7b-20a3-427a-8d9e-367b34184827', 'procedure', 'spotfire', 'procedure', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('783545a2-514f-4c90-acee-649e2df362f0', 'query', 'spotfire', 'query', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('e3fd5644-07a1-4a09-b05b-1d148f1f6786', 'datasource', 'spotfire', 'datasource', 0, null, null);

insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('04a1dc4d-6794-4c49-b91b-063de8a77450', 'analysisstate', 'spotfire', 'analysisstate', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
	values ('587870d1-ffc4-4ad7-9dd0-533f14414a58', 'task', 'spotfire', 'task', 0, null, 'text/xml');

insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
  values ('debd56cd-50bb-47b0-a458-84a2fccf3ca0', 'bookmark', 'spotfire', 'Bookmark', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
  values ('3f4fc3cd-dfc0-4e5a-b48e-7729769e411e', 'embeddedresource', 'spotfire', 'Embedded Resource', 0, null, null);
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
  values ('5b8d0632-5747-4e9c-a5e4-3900cc7590a1', 'analyticitem', 'spotfire', 'Analytic Item', 0, null, null);  
...
insert into LIB_ITEM_TYPES (TYPE_ID, LABEL, LABEL_PREFIX, DISPLAY_NAME, IS_CONTAINER, FILE_SUFFIX, MIME_TYPE) 
  values ('6cb16049-2fc7-43b7-916a-6d49551b54c9', 'sbdf', 'spotfire', 'Spotfire Binary Data Format', 0, 'sbdf', null);
...
insert into LIB_CONTENT_TYPES values (3, 'text/html');
